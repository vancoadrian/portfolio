...
const thesisImages = [
	...
	config.public.baseURL + 'bp/ActivityLogin.webp',
	config.public.baseURL + 'bp/Add IPs.webp',
	config.public.baseURL + 'bp/ComponentW.webp',
	config.public.baseURL + 'bp/Detail IPs.webp',
	config.public.baseURL + 'bp/gasEthereum.webp',
	config.public.baseURL + 'bp/gasIota.webp',
	config.public.baseURL + 'bp/IERC4907.webp',
	config.public.baseURL + 'bp/IERC4907_2.webp',
	config.public.baseURL + 'bp/Irentable.webp',
	config.public.baseURL + 'bp/Login Page.webp',
	config.public.baseURL + 'bp/MarketEvents.webp',
	config.public.baseURL + 'bp/MarketFunctions.webp',
	config.public.baseURL + 'bp/MarketLibrary.webp',
	config.public.baseURL + 'bp/Marketplace Page.webp',
	config.public.baseURL + 'bp/Marketplace.webp',
	config.public.baseURL + 'bp/My leased IPs page.webp',
	config.public.baseURL + 'bp/My monetized IPs page.webp',
	config.public.baseURL + 'bp/PrechodMedziObrazovkamiW.webp',
	config.public.baseURL + 'bp/Profile Page.webp',
	config.public.baseURL + 'bp/Rent IPs.webp',
	config.public.baseURL + 'bp/Rentable.webp',
	config.public.baseURL + 'bp/RentableOsetrenie.webp',
	config.public.baseURL + 'bp/RentableTransferUpdate.webp',
	config.public.baseURL + 'bp/SecurityMarketplace.webp',
	config.public.baseURL + 'bp/SecurityRentable.webp',
	config.public.baseURL + 'bp/SeqAddIP.webp',
	config.public.baseURL + 'bp/StateW.webp',
	config.public.baseURL + 'bp/testDeployed.webp',
	config.public.baseURL + 'bp/testMarketplace.webp',
	config.public.baseURL + 'bp/testRentable.webp',
	config.public.baseURL + 'bp/testTable.webp',
	config.public.baseURL + 'bp/Unlist IPs.webp',
	config.public.baseURL + 'bp/UsecaseW.webp',
];
</script>
